...
<head>
  ...
  <title>QLIKTAG</title>
  <link rel="shortcut icon" type="image/png" href="{{asset('materialm/')}}/src/assets/images/logos/favicon.png" />
      ...
      <div class="d-flex align-items-center justify-content-center w-100">
        <div class="row justify-content-center w-100">
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                <a href="{{asset('materialm/')}}/index.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                  <img src="{{asset('materialm/')}}/src/assets/images/logos/logo.svg" alt="">
                </a>
                <p class="text-center">QLIKTAG</p>
                    <form method="POST" action="{{ route('login') }}">
                    @csrf
                  <div class="mb-3">
